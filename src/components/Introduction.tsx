      ...
      <div className="introduction-page">
        ...
        <section className="content-section">
          ...
          <div className="content-image">
            <img src="https://fal.media/files/rabbit/tgMm7z4D-ApoScIgZaRnz.png" alt="Menstruation cycle" />
          </div>
        </section>
        ...
        <section className="content-section">
          <div className="content-image">
            <img src="https://fal.media/files/rabbit/tgMm7z4D-ApoScIgZaRnz.png" alt="Early periods in tweens" />
          </div>
          <div className="content-text">
            <h2>Why are tweens getting periods early?</h2>
            <p>
        ...
        <div className="image-break">
          <img src="https://fal.media/files/rabbit/tgMm7z4D-ApoScIgZaRnz.png" alt="Breaking taboos" />
        </div>
        <section className="carousel-section">
          <div className="carousel">
            <div className="carousel-item">
